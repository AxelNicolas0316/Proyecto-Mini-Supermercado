calcularValorTotal = function () {
    ...
    valorDescuento=ValorDescuento(valorSubtotal,porcentajeDescuento);
    ...
    */
mostarResumen="Valor a pagar por "+ cantidad+" "+nombreProducto+" con "+valorDescuento+"% "+"de descuento: USD"+valorTotal;
mostrarTexto("lblResumen",mostarResumen);

mostrarImagen("lblImagen","./imagenes/cerveza.gif");
alert("Gracias por su compra, vuelva pronto");
console.log("Compra Efectuada: "+mostarResumen);
}
